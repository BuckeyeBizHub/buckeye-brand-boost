          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 bg-primary text-primary-foreground rounded-2xl px-6 py-3 shadow-lg">
                ...
                <p className="text-xs text-primary-foreground/80">Your Buckeye Branding Concierge</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground leading-[1.9] space-y-6">
              ...
              <div className="mt-10 pt-8 border-t border-border">
                ...
                <p className="text-2xl font-display font-black text-primary mb-1">David Stein, Your Buckeye Branding Concierge</p>
